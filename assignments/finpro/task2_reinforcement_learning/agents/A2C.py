...
class PolicyNetwork(nn.Module):
    def __init__(self, obs_space_dims: int, action_space_dims: int, hidden1:int, hidden2:int):
        ...
        self.hidden1 = hidden1
        self.hidden2 = hidden2
        self.fc1 = nn.Linear(obs_space_dims, hidden1)
        self.fc2 = nn.Linear(hidden1, hidden2)
        self.mean = nn.Linear(hidden2, action_space_dims)
        self.log_std = nn.Linear(hidden2, action_space_dims)
...
class ValueNetwork(nn.Module):
    def __init__(self, obs_space_dims: int, hidden1:int, hidden2:int):
        super().__init__()
        self.hidden1 = hidden1
        self.hidden2 = hidden2
        self.fc1 = nn.Linear(obs_space_dims, self.hidden1)
        self.fc2 = nn.Linear(self.hidden1, self.hidden2)
        self.value = nn.Linear(self.hidden2, 1)
